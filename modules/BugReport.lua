...
function Wise:CreateBugReportWindow()
	if Wise.BugReportFrame then
		return Wise.BugReportFrame
	end
...
function Wise:GenerateBugReportLink()
	...
	local body = "**Description:**\n"
		...
		.. "\n"
		.. "Combat: "
		.. tostring(runtime.system.combat)
		.. "\n"
		.. "Zone: "
		.. (runtime.system.zone or "?")
		.. "\n\n"
		.. "**Active Conditionals:**\n"
	...
	if urlLen > 2000 then
		...
		f.Instructions:SetText(
			"|cffff0000Report too long for direct link!|r Please copy the text below and paste it into the GitHub issue body."
		)
	end
